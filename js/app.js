...
function callSpotify() {
  let accessToken = "BQDrNxu74lLL30iISaOsqUSbyVYTlZk8_nZJ9GCf7hcqET6tskzxCBMQn5aMaxBCNVNDG6YcD5CEfReGhXexqtUN7RutIdp3QPc7RqlRPV2YoFeaZXMDlsR4Pc-r_UNGVfBZch2LMcS259sfmMCpqLMbJTDQd_XQ3pPXJmPA99k8mf2A9g"
...
function loadEvents() {
  ...
  session.EVENT_ARR.forEach(event => {
    ...
    var html =
      ...
      <iframe src="https://open.spotify.com/embed/artist/${event.spotifyId}"
